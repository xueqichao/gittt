        ...
        $(function (){
            $(".link-del").click(function (){
                ...
                if(flag){
                    ...
                    $("tr[id="+aid+"]").remove();
                    location.href="adminArticleData";
                }
            });
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">工作者文章管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-content">
                    ...
                    <div class="list-page">
                        ...
                        <a href="adminArticleData?cp=1">首页</a>
                        <a href="adminArticleData?cp=${requestScope.currentpage-1<1?1:requestScope.currentpage-1}">上一页</a>
                        <a href="adminArticleData?cp=${requestScope.currentpage+1>requestScope.tpage?requestScope.tpage:requestScope.currentpage+1}">下一页</a>
                        <a href="adminArticleData?cp=${requestScope.tpage}">尾页</a>
                    </div>
                </div>
            </form>
        </div>
