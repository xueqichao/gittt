...
@WebServlet("/userConsult")
public class UserConsult extends HttpServlet
{
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<User> workerList= userService.findWorker();

        request.setAttribute("workerList",workerList);

        request.getRequestDispatcher("userconsult.jsp").forward(request,response);
    }
